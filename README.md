...
This is a Reveal.js-based online resume.

## Local development

Install deps (this will also sync Reveal’s runtime assets into `vendor/reveal/`):
...
If you ever need to re-sync the vendored Reveal assets:
